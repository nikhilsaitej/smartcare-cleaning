...
import { Mail, Lock, LogIn, Loader2, Phone } from "lucide-react";
              ...
              <CardContent className="p-8">
                <div className="space-y-3 mb-6">
                  <Button
                    type="button"
                    variant="outline"
                    className="w-full h-12 font-semibold flex items-center justify-center gap-2 border-2 border-slate-200 hover:bg-slate-50"
                  ...
                  <Button
                    type="button"
                    variant="outline"
                    className="w-full h-12 font-semibold flex items-center justify-center gap-2 border-2 border-slate-200 hover:bg-blue-50"
