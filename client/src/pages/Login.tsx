          ...
          <div className="max-w-md mx-auto">
            <Card className="shadow-xl border-none">
              ...
              <CardContent className="p-8">
                {/* DEBUG: Google Button should be here */}
                <Button
                  type="button"
                  variant="outline"
                  className="w-full h-12 mb-6 font-semibold flex items-center justify-center gap-2 border-2 border-slate-200 hover:bg-slate-50"
