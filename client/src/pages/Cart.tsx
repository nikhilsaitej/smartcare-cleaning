...
export default function Cart() {
  // Mock cart items using some products from constants
          ...
          {items.length === 0 ? (
            <Card className="text-center py-20">
              <CardContent>
                ...
                <Link href="/#products">
                  <Button className="bg-primary hover:bg-primary/90 px-8">Continue Shopping</Button>
                </Link>
              </CardContent>
            </Card>
          ) : (
              ...
              <div className="lg:col-span-1">
                <Card className="border-none shadow-lg sticky top-24">
                  <CardContent className="p-6">
                    ...
                    <Button className="w-full bg-orange-500 hover:bg-orange-600 h-12 text-lg font-bold shadow-lg shadow-orange-500/20">
